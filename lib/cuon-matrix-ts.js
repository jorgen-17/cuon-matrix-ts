...
var Vec3 = (function () {
    ...
    Vec3.rotate = function (vector, axis, angle) {
        var cos = Math.cos(angle);
        var sin = Math.sin(angle);
        var normalizedAxis = this.normalize(axis);
        var crossProduct = Vec3.cross(normalizedAxis, vector);
        var dotProduct = vector.dot(normalizedAxis);
        return new Vec3(vector.x * cos + crossProduct.x * sin + normalizedAxis.x * dotProduct * (1 - cos), vector.y * cos + crossProduct.y * sin + normalizedAxis.y * dotProduct * (1 - cos), vector.z * cos + crossProduct.z * sin + normalizedAxis.z * dotProduct * (1 - cos));
    };
    ...
    Vec3.prototype.angle = function (other) {
        var result = 0;
        var cross = Vec3.cross(this, other);
        var len = Math.sqrt(cross.x * cross.x + cross.y * cross.y + cross.z * cross.z);
    ...
    Vec3.prototype.rotate = function (axis, angle) {
        ...
        var d = axis.z * a;
        a = Math.cos(angle);
        var w = new Vec3(b, c, d);
        var wv = Vec3.cross(w, this);
        var wwv = Vec3.cross(w, wv);
        a *= 2;
        wv.x *= a;
        wv.y *= a;
        wv.z *= a;
...
var Vec4 = (function () {
    ...
    Vec4.getLength = function (v) {
        return Math.sqrt(v.x * v.x + v.y * v.y + v.z * v.z + v.w * v.w);
    };
    Vec4.normalize = function (v) {
        var length = Vec4.getLength(v);
...
var Vec2 = (function () {
    ...
    Vec2.getLength = function (v) {
        return Math.sqrt(v.x * v.x + v.y * v.y);
    };
    Vec2.normalize = function (v) {
        var length = Vec2.getLength(v);
